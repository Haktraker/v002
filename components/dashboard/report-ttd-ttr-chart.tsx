...
import { useGetTtdTtrRecords } from '@/lib/api/endpoints/reports/ttd-ttr';
import { TtdTtrQueryParams, TtdTtr } from '@/lib/api/reports-types/types';
  ...
  return (
    <Card className={`flex-1 ${isDark ? "bg-[#171727] border-0" : "bg-white"}`}>
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <Link href="/dashboard/reports/ttd-ttr">
