...
import { useGetThirdPartyThreats } from '@/lib/api/endpoints/executive-dashboard/third-party-threat-intelligence';
import { ThirdPartyThreatIntelligence, ThirdPartyThreatIntelligenceQueryParams, SeverityLevel } from '@/lib/api/executive-dashboard-types/types';
...
const ThirdPartyThreatIntelligenceChart = () => {
  ...
  const queryParams: ThirdPartyThreatIntelligenceQueryParams = useMemo(() => ({
