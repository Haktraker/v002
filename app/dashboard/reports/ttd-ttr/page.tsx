...
import { useGetTtdTtrRecords, useDeleteTtdTtrRecord } from '@/lib/api/endpoints/reports/ttd-ttr';
import { Button } from '@/components/ui/button';
import { Pencil, Trash2 } from 'lucide-react';
import { toast } from 'sonner';
import { TtdTtr, TtdTtrIndicator } from '@/lib/api/reports-types/types';
...
export default function TtdTtrPage() {
  ...
  const tableStyle = useTableStyle<CombinedTtdTtr>({
    ...
    enableSorting: true,
    sortableColumns: ['ttdScore', 'ttrScore', 'month', 'year'],
  });
    ...
    <PageContainer>
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2">
          <Link href="/dashboard/reports/ttd-ttr/new">
