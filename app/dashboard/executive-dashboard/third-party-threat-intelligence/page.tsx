...
import { useGetThirdPartyThreats, useDeleteThirdPartyThreat } from '@/lib/api/endpoints/executive-dashboard/third-party-threat-intelligence';
import { Button } from '@/components/ui/button';
import { Pencil } from 'lucide-react';
import { toast } from 'sonner';
import { ThirdPartyThreatIntelligence, SeverityLevel } from '@/lib/api/executive-dashboard-types/types';
...
const severityBadgeVariant: Record<SeverityLevel, "default" | "secondary" | "destructive" | "outline" | null | undefined > = {
  ...
  medium: 'secondary',
  high: 'destructive',
  critical: 'destructive', // Consider a different variant for critical if needed
};
...
export default function ThirdPartyThreatIntelligencePage() {
  ...
  const handleUpdate = (record: ThirdPartyThreatIntelligence) => {
  ...
  // --- Table Setup ---
  const tableStyle = useTableStyle<ThirdPartyThreatIntelligence>({
    enableSelection: true,
    enableSorting: true,
    sortableColumns: ['thirdParty', 'severity', 'month', 'year', 'quarter', 'createdAt', 'updatedAt'],
  ...
  const columns = useMemo<ColumnDef<ThirdPartyThreatIntelligence>[]>(() => [
    ...
    <PageContainer>
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link href="/dashboard/executive-dashboard/third-party-threat-intelligence/new">
